...
export default function Application(props) {
  ...
  const appt = appointmentObjs.map((appointmentObj) => {
    ...
    return (
      <Appointment key={appointmentObj.id} id={appointmentObj.id} time={appointmentObj.time} interview={interview} interviewers={interviewers} bookInterview={bookInterview} cancelInterview={cancelInterview}/>
    )
  })
